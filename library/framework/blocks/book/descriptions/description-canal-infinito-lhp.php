<?php
global $wpdb;
$query = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}wpdatatable_123");
      ...
      <tr>
        ...
        <td style="width: 20px; padding: 10px;">
          ...
          if ($imageString != 'No existe') {
            ...
            $fullImagePath = 'https://bibliotecaenigmas.com/wp-content/themes/sahifa/library/images/covers/canal-infinito-lhp/' . $imageString . '.jpg';
            $smallImagePath = 'https://bibliotecaenigmas.com/wp-content/themes/sahifa/library/images/covers/canal-infinito-lhp/small/' . $imageString . '.jpg';
