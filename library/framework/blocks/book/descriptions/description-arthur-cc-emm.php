<?php
global $wpdb;
$query = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}wpdatatable_118");
      ...
      <tr>
        ...
        <td style="width: 20px; padding: 10px;">
          ...
          if ($imageString != 'No existe') {
            ...
            $fullImagePath = 'https://bibliotecaenigmas.com/wp-content/themes/sahifa/library/images/covers/arthur-cc-emm/' . $imageString . '.jpg';
            $smallImagePath = 'https://bibliotecaenigmas.com/wp-content/themes/sahifa/library/images/covers/arthur-cc-emm/small/' . $imageString . '.jpg';
