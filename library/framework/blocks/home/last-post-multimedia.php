 ...
 * Description:        This file shows the last post multimedia section in home page.
 * Date:               15-03-2026
 */
?>
...
<section>
  <div class="tb-head">
    <h1>= Últimas publicaciones de "Multimedia" =</h1>
  </div>
</section>
              ...
              <?php if (function_exists("has_post_thumbnail") && has_post_thumbnail()) : ?>
                ...
                <section>
                  ...
                  if ($be_theme_check != 'yes') {
                    ...
                    echo '<div  class="post-thumbnail tie_play tie-appear tb-card-book-thumbnail">';
                  }
                  ?>
      ...
      <div class="col_-12">
        ...
        <section>
          <div class="text-center">
            <a title="Ir a la sección multimedia" href="https://bibliotecaenigmas.com/genre/multimedia/"
