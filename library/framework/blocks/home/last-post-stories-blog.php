 ...
 * File name:          last-post-stories-blog.php
 * Description:        This file shows the last stories writer blog section in home page.
 * Date:               15-03-2026
 */
?>
...
<section>
  <div class="tb-head">
    <h2>= Últimas publicaciones de "Cuentos del autor" =</h2>
  </div><!--/.tb-head-->
</section>
  ...
  <div class="tb-box">
      ...
      if ($wp_query->have_posts()) : while ($wp_query->have_posts()) : $wp_query->the_post();
        ...
        <div class="col_-xxl-4 col_-xl-4 col_-md-4  <?php echo $class; ?> col_xs-12 text-center mb10">
          <div class="tb-card-blog">
            ...
            <div class="post-thumbnail tie_story tb-card-blog-thumbnail tie-appear">
    ...
    <section>
      <div class="text-center">
        <a title="Ir a cuentos del autor" href="https://bibliotecaenigmas.com/category/cuentos-del-autor/"
