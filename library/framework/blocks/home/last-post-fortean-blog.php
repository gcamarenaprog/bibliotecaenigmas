...
<section>
  <div class="tb-head">
    <h1>= Últimas publicaciones del "Blog forteano" =</h1>
  </div>
</section>
  ...
  <div class="tb-box">
      ...
      if ($wp_query->have_posts()) : while ($wp_query->have_posts()) : $wp_query->the_post();
        ...
        <div class="col_-xxl-4 col_-xl-4 col_-md-4  <?php echo $class; ?> col_xs-12 text-center mb10">
          <div class="tb-card-blog">
            ...
            <div class="post-thumbnail tie_fortean tb-card-blog-thumbnail tie-appear">
    ...
    <section>
      <div class="text-center">
        <a title="Ir al blog forteano" href="https://bibliotecaenigmas.com/category/blog-forteano/"
