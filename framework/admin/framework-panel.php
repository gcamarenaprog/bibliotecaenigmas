...
# Save Theme Settings
/*-----------------------------------------------------------------------------------*/
function tie_save_settings ( $data = false , $refresh = 0 ) {
...
function tie_add_admin() {
	...
	add_submenu_page('panel',  __( 'Import Demo', 'tie' ), __( 'Import Demo', 'tie' ),'switch_themes', 'tie_demo_installer' , 'tie_demo_installer');
...
/*-----------------------------------------------------------------------------------*/
function tie_options ( $value = false ){
	$data = false;
		...
		<div id="tab10" class="tab_content tabs-wrap">
			...
			<div class="tiepanel-item">
				...
				<?php
					...
					tie_options(
					array(
						'name' => __( 'Use the Classic Widgets Page', 'tie' ),
