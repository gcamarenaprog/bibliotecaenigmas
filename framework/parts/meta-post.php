<?php
global $get_meta;
if( ( tie_get_option( 'post_meta' ) && empty( $get_meta["tie_hide_meta"][0] ) ) || ( ! empty( $get_meta["tie_hide_meta"][0] ) && $get_meta["tie_hide_meta"][0] == 'no' ) ): ?>		
<p class="post-meta">
...
<?php if( tie_get_option( 'post_cats' ) ): ?>
	<span class="post-cats"><i class="fa-solid fa-arrow-down-a-z"></i><?php printf('%1$s', get_the_category_list( ', ' ) ); ?></span>
<?php endif; ?>	
