  ...
  // Normal Page
    ...
    <?php if (have_posts ())
      while (have_posts ()) : the_post (); ?>
        ...
        <div class="content<?php if (!empty($get_meta["tie_post_head_cover"][0]))
          echo ' post-cover'; ?>">
        ...
        <article <?php post_class ('post-listing post'); ?> id="the-post">
          ...
          <div class="post-inner ">
            ...
            <div class="entry mt20">
              <?php if (tie_get_option ('share_buttons_pages') && tie_get_option ('share_post_top') && (!function_exists ('is_buddypress') || (function_exists ('is_buddypress') && !is_buddypress ())))
                get_template_part ('framework/parts/share'); // Get Share Button template ?>
            ...
            <?php if (tie_get_option ('share_buttons_pages') && tie_get_option ('share_post') && (!function_exists ('is_buddypress') || (function_exists ('is_buddypress') && !is_buddypress ())))
              get_template_part ('framework/parts/share'); // Get Share Button template ?>
            <div class="clear"></div>
          </div><!-- .post-inner -->
